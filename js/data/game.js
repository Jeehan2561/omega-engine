const game = {
    ...
    achievements: [
        new Achievement("You played!", "Welcome to Omega Layers: Recrumbled :D", "&omega;", () => true),
        ...
        new Achievement("Upgradalicious", "Max all the non-meta upgrades", "↑<sub>↑<sub>↑</sub></sub>", () => (Object.values(game.restackLayer.permUpgrades).filter(u => u.level.gt(0)).length + Object.values(game.restackLayer.permUpgrades).filter(u => u.level.gt(1)).length) == 6),
        ...
        new Achievement("Endgame", "Reach layer 11 and finish "+mod.primaryName+mod.secondaryName, "Ʊ", () => game.metaLayer.layer.gte(11)),
    ],
    secretAchievements: [
