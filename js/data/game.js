const game = {
    ...
    achievements: [
        ...
        new Achievement("ƒ(x) = 5", "Reach 9.12e456 &#0131;P Reward: Unlock another row of Number Upgrades", '<span class="aleph">&#0131;<sub>5</sub></span>', () => Decimal.gte(game.functionsLayer.functionsPoints, "9.12e456")),
        ...
        new Achievement("Fine.", "First Functions upgrade's effect goes to ^100 Reward: Unlock 2 Enhancers", "😐", () => game.functionsLayer.upgrades.ResourceMultipliersBasedOnLayers.apply().gte("100")),
        new Achievement("Xtreme", "Increase your <b>x</b> 500 times Reward: Unlock 2 more Enhancers", '<span class="aleph">&#0131;<sub>X</sub></span>', () => game.functionsLayer.upgrades.Variable_X.apply().gte("500")),
